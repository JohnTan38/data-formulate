...
// node_modules/react-selectable-fast/lib/utils/castTouchToMouseEvent.js
var require_castTouchToMouseEvent = __commonJS({
  "node_modules/react-selectable-fast/lib/utils/castTouchToMouseEvent.js"(exports) {
    "use strict";
...
// node_modules/react-selectable-fast/lib/utils/detectMouseButton.js
var require_detectMouseButton = __commonJS({
  "node_modules/react-selectable-fast/lib/utils/detectMouseButton.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function detectMouseButton(evt, buttonNumber, options) {
      ...
      if (evt.metaKey && !options.allowMetaClick || evt.ctrlKey && !options.allowCtrlClick || evt.altKey && !options.allowAltClick || evt.shiftKey && !options.allowShiftClick) {
        return false;
      }
      if ("buttons" in evt) {
...
// node_modules/react-selectable-fast/lib/utils/doObjectsCollide.js
var require_doObjectsCollide = __commonJS({
  "node_modules/react-selectable-fast/lib/utils/doObjectsCollide.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var areBoundsCollide = function(a, b, _a) {
      ...
      return !(a.top + aHeight - tolerance < b.top || a.top + tolerance > b.top + bHeight || a.left + aWidth - tolerance < b.left || a.left + tolerance > b.left + bWidth);
    };
...
// node_modules/react-selectable-fast/lib/utils/getBoundsForNode.js
var require_getBoundsForNode = __commonJS({
  "node_modules/react-selectable-fast/lib/utils/getBoundsForNode.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function getBoundsForNode(node, containerScroll) {
      ...
      return Array.from(node.getClientRects()).map(function(rect) {
        return {
...
// node_modules/react-selectable-fast/lib/utils/nodeInRoot.js
var require_nodeInRoot = __commonJS({
  "node_modules/react-selectable-fast/lib/utils/nodeInRoot.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/react-selectable-fast/lib/utils/index.js
var require_utils = __commonJS({
  "node_modules/react-selectable-fast/lib/utils/index.js"(exports) {
    "use strict";
    function __export(m) {
    ...
    __export(require_castTouchToMouseEvent());
    __export(require_detectMouseButton());
    __export(require_doObjectsCollide());
    __export(require_getBoundsForNode());
    __export(require_nodeInRoot());
  }
});

// node_modules/react-selectable-fast/lib/SelectableGroup.context.js
var require_SelectableGroup_context = __commonJS({
  "node_modules/react-selectable-fast/lib/SelectableGroup.context.js"(exports) {
    "use strict";
...
// node_modules/react-selectable-fast/lib/Selectbox.js
var require_Selectbox = __commonJS({
  "node_modules/react-selectable-fast/lib/Selectbox.js"(exports) {
    "use strict";
    ...
    function Selectbox(props) {
      ...
      return react_1.default.createElement("div", { className, style: boxStyle });
    }
...
// node_modules/react-selectable-fast/lib/SelectableGroup.js
var require_SelectableGroup = __commonJS({
  "node_modules/react-selectable-fast/lib/SelectableGroup.js"(exports) {
    "use strict";
    ...
    var react_1 = __importStar(require_react());
    var utils_1 = require_utils();
    var SelectableGroup_context_1 = require_SelectableGroup_context();
    var Selectbox_1 = require_Selectbox();
    var SelectableGroup = function(_super) {
      __extends(SelectableGroup2, _super);
      function SelectableGroup2() {
        ...
        _this.registry = /* @__PURE__ */ new Set();
        _this.selectedItems = /* @__PURE__ */ new Set();
        _this.selectingItems = /* @__PURE__ */ new Set();
        _this.ignoreCheckCache = /* @__PURE__ */ new Map();
      ...
      SelectableGroup2.prototype.componentDidMount = function() {
      ...
      SelectableGroup2.prototype.componentWillUnmount = function() {
      ...
      Object.defineProperty(SelectableGroup2.prototype, "containerDocumentScroll", {
        get: function() {
          return {
      ...
      SelectableGroup2.prototype.removeTempEventListeners = function() {
      ...
      SelectableGroup2.prototype.updateRootBounds = function() {
      ...
      SelectableGroup2.prototype.toggleSelectionMode = function() {
      ...
      SelectableGroup2.prototype.processItem = function(options) {
      ...
      SelectableGroup2.prototype.isInIgnoreList = function(target) {
        if (!target) {
          return;
        }
        if (this.ignoreCheckCache.get(target) !== void 0) {
      ...
      SelectableGroup2.prototype.removeIgnoredItemsFromRegistry = function() {
        var _this = this;
        this.ignoreListNodes = Array.from(document.querySelectorAll(this.ignoreList.join(", ")));
        this.registry = new Set(__spread(this.registry).filter(function(item) {
          return !_this.isInIgnoreList(item.node);
        }));
        this.selectedItems = new Set(__spread(this.selectedItems).filter(function(item) {
          return !_this.isInIgnoreList(item.node);
        }));
      };
      SelectableGroup2.prototype.preventEvent = function(target, type) {
      ...
      SelectableGroup2.prototype.cleanUp = function() {
        var e_6, _a;
      ...
      SelectableGroup2.prototype.handleClick = function(evt, top, left) {
        ...
        if (allowClickWithoutSelected || this.selectedItems.size || isMouseUpOnClickElement || evt.ctrlKey) {
          this.selectItems({
            top,
            left,
            width: 0,
      ...
      SelectableGroup2.prototype.render = function() {
        ...
        return react_1.default.createElement(
          SelectableGroup_context_1.SelectableGroupContext.Provider,
          { value: this.contextValue },
          react_1.default.createElement(
            GroupComponent,
            { ref: this.getGroupRef, style: __assign(__assign({}, this.defaultContainerStyle), style), className: className + " " + (selectionMode ? selectionModeClass : "") },
            children,
            react_1.default.createElement(Selectbox_1.Selectbox, { getSetState: this.getSelectboxSetState, className: selectboxClassName, fixedPosition })
          )
        );
      };
      SelectableGroup2.defaultProps = {
        clickClassName: "",
        tolerance: 0,
        globalMouse: false,
        ignoreList: [],
      ...
      return SelectableGroup2;
    }(react_1.Component);
    exports.SelectableGroup = SelectableGroup;
  }
});

// node_modules/react-selectable-fast/lib/CreateSelectable.js
var require_CreateSelectable = __commonJS({
  "node_modules/react-selectable-fast/lib/CreateSelectable.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var utils_1 = require_utils();
    var SelectableGroup_context_1 = require_SelectableGroup_context();
    exports.createSelectable = function(WrappedComponent) {
      var _a;
      ...
      }(react_1.Component), _a.contextType = SelectableGroup_context_1.SelectableGroupContext, _a.defaultProps = {
        isSelected: false
      }, _a;
    };
  }
...
// node_modules/react-selectable-fast/lib/SelectAll.js
var require_SelectAll = __commonJS({
  "node_modules/react-selectable-fast/lib/SelectAll.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var SelectAll = function(_super) {
      ...
      SelectAll2.prototype.componentDidMount = function() {
        this.root.addEventListener("mousedown", function(evt) {
          return evt.stopPropagation();
        });
      };
      SelectAll2.prototype.render = function() {
      ...
      SelectAll2.contextType = SelectableGroup_context_1.SelectableGroupContext;
      return SelectAll2;
    }(react_1.Component);
...
// node_modules/react-selectable-fast/lib/DeselectAll.js
var require_DeselectAll = __commonJS({
  "node_modules/react-selectable-fast/lib/DeselectAll.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var DeselectAll = function(_super) {
      ...
      DeselectAll2.prototype.componentDidMount = function() {
        this.root.addEventListener("mousedown", function(evt) {
          return evt.stopPropagation();
        });
      };
      DeselectAll2.prototype.render = function() {
      ...
      DeselectAll2.contextType = SelectableGroup_context_1.SelectableGroupContext;
      return DeselectAll2;
    }(react_1.Component);
...
// node_modules/react-selectable-fast/lib/index.js
var require_lib = __commonJS({
  "node_modules/react-selectable-fast/lib/index.js"(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    var SelectableGroup_1 = require_SelectableGroup();
    exports.SelectableGroup = SelectableGroup_1.SelectableGroup;
    var CreateSelectable_1 = require_CreateSelectable();
    exports.createSelectable = CreateSelectable_1.createSelectable;
    var SelectAll_1 = require_SelectAll();
    exports.SelectAll = SelectAll_1.SelectAll;
    var DeselectAll_1 = require_DeselectAll();

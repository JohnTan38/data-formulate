...
// node_modules/react-animate-on-change/index.js
var require_react_animate_on_change = __commonJS({
  "node_modules/react-animate-on-change/index.js"(exports) {
    ...
    var AnimateOnChange = (
      /** @class */
      function(_super) {
        __extends(AnimateOnChange2, _super);
        function AnimateOnChange2(props) {
        ...
        AnimateOnChange2.prototype.animationEnd = function(e) {
        ...
        AnimateOnChange2.prototype.shouldComponentUpdate = function(nextProps, nextState) {
          if (this.state.animating !== nextState.animating) {
            return false;
          }
          return true;
        };
        AnimateOnChange2.prototype.render = function() {
          var clearAnimationClass = this.state.clearAnimationClass;
          var _a = this.props, baseClassName = _a.baseClassName, animate = _a.animate, animationClassName = _a.animationClassName, customTag = _a.customTag, children = _a.children, onAnimationEnd = _a.onAnimationEnd, otherProps = __rest(_a, ["baseClassName", "animate", "animationClassName", "customTag", "children", "onAnimationEnd"]);
          var className = baseClassName;
          if (animate && !clearAnimationClass) {
            className += " " + animationClassName;
          }
          var Tag = customTag || "span";
          return react_1.default.createElement(Tag, __assign({ ref: this.setElementRef, className }, otherProps), children);
        };
        return AnimateOnChange2;
      }(react_1.Component)
    );
    exports.default = AnimateOnChange;
  }
});
export default require_react_animate_on_change();
//# sourceMappingURL=react-animate-on-change.js.map
